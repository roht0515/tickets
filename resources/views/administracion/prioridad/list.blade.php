...
@php
$headers = ['Nombre', 'Nivel prioridad', 'Fecha de creacion', 'Fecha de actualizacion', 'id'];
$columns = [
    ['data'=>'name','name'=>'name'],
    ['data'=>'level_priority', 'name'=>'level_priority'],
...
@include('administracion.prioridad.form.form')
</x-form>
...
<script>
    ...
    $('#ServiceModal').validate({
            ...
            {   $route = "";
                ...
                if(crear) {
                    $route = "{{route('storePriority')}}"
                }
                else {
                    $route = "{{route('editPriority')}}"
                }
                $.ajax({
                        type: "POST",
                        url: $route,
