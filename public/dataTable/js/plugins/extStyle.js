...
$.fn.dataTableExt.oPagination.extStyle = {
	fnInit: function(oSettings, nPaging, fnCallbackDraw) {
		...
		nFirst = $('<span/>', {
			class: 'paginate_button first fas fa-angle-double-left',
			text: ' '
		});
		nPrevious = $('<span/>', {
			class: 'paginate_button previous fas fa-chevron-left',
			text: ' '
		});
		nNext = $('<span/>', {
			class: 'paginate_button next fas fa-chevron-right',
			text: ' '
		});
		nLast = $('<span/>', {
			class: 'paginate_button last fas fa-angle-double-right',
			text: ' '
		});
		nPageTxt = $('<span/>', {
			text: 'Pagina '
